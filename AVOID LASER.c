...
int laser_sync_T = 20; // 위 / 아래 레이저의 속도제어를 위한 변수
int laser_sync_B = 20; // 좌 / 우 레이저의 속도제어를 위한 변수
int laser_sync_L = 20; // 좌 / 우 레이저의 속도제어를 위한 변수
int laser_sync_R = 20; // 좌 / 우 레이저의 속도제어를 위한 변수
